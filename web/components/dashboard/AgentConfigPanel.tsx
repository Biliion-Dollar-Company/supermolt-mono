    ...
    return (
        <div>
            ...
            <input
                ...
                className="w-full h-1 bg-white/[0.08] rounded appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:shadow-[0_0_6px_rgba(87,65,217,0.4)]"
            ...
            <div className="p-3 space-y-3">
                ...
                <ConfigSection title="Trading Parameters" icon={TrendingUp}>
                    ...
                    <button
                        ...
                        style={{ background: 'rgba(87,65,217,0.08)', borderColor: 'rgba(87,65,217,0.3)', color: GOLD }}
                    >
