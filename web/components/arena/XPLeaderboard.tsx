              ...
              <div key={entry.agentId}>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-semibold text-white/80 truncate group-hover:text-[#5741D9] transition-colors">
                        {entry.name}
                      </span>
                  ...
                  <div className="text-right flex-shrink-0">
                    <div className="text-sm font-mono text-[#5741D9]">{entry.xp.toLocaleString()}</div>
