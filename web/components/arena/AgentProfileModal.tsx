...
function CornerBrackets() {
  const corner = 'absolute w-3 h-3 border-[#5741D9]/30';
  return (
    <>
  ...
  return createPortal(
    ...
    >
      ...
      <div className="relative flex items-center justify-center h-full p-4 pointer-events-none">
        <div
          ref={panelRef}
          className="relative w-full max-w-lg max-h-[85vh] overflow-y-auto scrollbar-custom pointer-events-auto bg-bg-primary border border-white/[0.06] shadow-[0_0_80px_-16px_rgba(87,65,217,0.12)]"
          style={{
            opacity: 0,
          ...
          {loading ? (
            ...
            <div>
              ...
              <div className="absolute top-3 right-3 z-10 flex items-center gap-0.5">
                ...
                >
                  {shareCopied ? <Check size={14} style={{ color: '#5741D9' }} /> : <Share2 size={14} className="text-white/35" />}
                </button>
                <button
                  onClick={handleClose}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {profile && (
                        <span className="text-[10px] font-bold text-[#5741D9] bg-[#5741D9]/10 px-1.5 py-0.5 font-mono flex-shrink-0">
                ...
                <>
                  ...
                  >
                    ...
                    {openPositions.length > 5 && (
                      <a
                        href={`/agents/${agentId}`}
                        className="inline-block text-xs text-white/35 hover:text-[#5741D9] transition-colors mt-2"
                      >
                          ...
                          <div className="flex items-center gap-2 py-0.5">
                            {item.kind === 'task' ? (
                              <>
                                ...
                                <span className="text-[10px] font-mono text-[#5741D9] flex-shrink-0">
                                  +{item.xp} XP
                                </span>
                              </>
                            ) : (
              ...
              >
                <a
                  href={`/agents/${agentId}`}
                  className="inline-flex items-center gap-1.5 text-xs text-white/35 hover:text-[#5741D9] transition-colors"
                >
                  Full profile
