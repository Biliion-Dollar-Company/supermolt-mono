  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-16">
        <Loader2 className="w-6 h-6 text-[#5741D9] animate-spin" />
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl space-y-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-white font-semibold text-base flex items-center gap-2">
              <Wallet className="w-4 h-4 text-[#5741D9]" />
              Tracked Wallets
            </h3>
            ...
            <DialogContent className="sm:max-w-[500px] bg-[#0f0f0f] border-white/[0.08]">
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="flex gap-2 justify-end pt-2">
                  ...
                  <Button onClick={handleAddWallet} disabled={!newAddress.trim()} className="bg-[#5741D9] hover:bg-[#5741D9]/80 text-black">
                    Add Wallet
                  </Button>
                </div>
              </div>
      ...
      <div className="bg-[#0C1020] border border-white/[0.08] rounded-lg p-5">
        <div className="mb-4">
          <h3 className="text-white font-semibold text-base flex items-center gap-2">
            <Zap className="w-4 h-4 text-[#5741D9]" />
            Buy Triggers
          </h3>
          <p className="text-white/40 text-xs mt-1">
      ...
      <div className="flex justify-end">
        <Button
          onClick={handleSave}
          disabled={saving}
          className="bg-[#5741D9] hover:bg-[#5741D9]/80 text-black font-medium px-6"
        >
          {saving ? (
...
function TriggerCard({
  ...
  return (
    <div className={`border rounded-lg p-4 transition-colors ${enabled ? 'border-[#5741D9]/30 bg-[#5741D9]/[0.02]' : 'border-white/[0.06]'}`}>
