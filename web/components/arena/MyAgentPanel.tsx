...
export function MyAgentPanel() {
  ...
  return (
    <div className="bg-[#0C1020] border border-white/[0.08] shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_8px_32px_rgba(0,0,0,0.4)] overflow-hidden">
      ...
      >
        {/* Avatar */}
        <div className="w-20 h-20 bg-[#5741D9]/10 border-2 border-[#5741D9]/25 flex items-center justify-center flex-shrink-0 overflow-hidden">
          {avatarUrl ? (
            <img src={avatarUrl} alt={displayName} className="w-full h-full object-cover" />
          ) : (
            <span className="text-[#5741D9] font-bold text-3xl">
        ...
        <div className="flex flex-col items-start min-w-0 flex-1">
          ...
          <div className="flex items-center gap-3 mt-2 w-full">
            <span className="bg-[#5741D9]/15 border border-[#5741D9]/25 px-2 py-0.5 text-xs font-bold text-[#5741D9] whitespace-nowrap">
              Lv.{agent.level}
            </span>
                ...
                {PANEL_TABS.map((tab) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {tab.label}
                      {isActive && (
                        <span className="absolute bottom-0 left-1 right-1 h-[2px] bg-[#5741D9]" />
                      )}
                    </button>
                  );
                })}
