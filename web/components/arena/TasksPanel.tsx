...
const STATUS_LABELS: Record<string, { label: string; color: string }> = {
  OPEN: { label: 'Open', color: 'text-[#5741D9]' },
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <Icon className={`w-6 h-6 flex-shrink-0 ${isDone ? 'text-green-400' : 'text-[#5741D9]'}`} />
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none">
        ...
        >
          ...
          <div className="bg-bg-primary border border-white/[0.1] border-b-0 px-5 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              {(() => { const Icon = TASK_ICONS[task.taskType] || ClipboardCheck; return <Icon className="w-6 h-6 text-[#5741D9]" />; })()}
              <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        ...
                        className="flex items-center justify-center gap-2 w-full px-4 py-2 bg-[#5741D9]/10 border border-[#5741D9]/30 text-[#5741D9] hover:bg-[#5741D9]/20 transition-all text-sm font-medium cursor-pointer"
                      >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        ...
                        className="flex items-center justify-center gap-2 w-full px-4 py-2 bg-[#5741D9]/10 border border-[#5741D9]/30 text-[#5741D9] hover:bg-[#5741D9]/20 transition-all text-sm font-medium disabled:opacity-50 cursor-pointer"
                      >
                        {isSigningIn ? (
                          <>
