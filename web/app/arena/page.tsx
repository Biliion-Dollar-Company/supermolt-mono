...
import { ArenaLeaderboard, TokenDetailContent, EpochRewardPanel, GraduationPanel, TasksPanel, MyAgentPanel, XPLeaderboard, ConversationsPanel, TradeRecommendationBanner } from '@/components/arena';
    ...
    <div className="min-h-screen bg-bg-primary pt-18 sm:pt-20 pb-16 px-4 sm:px-[8%] lg:px-[15%] relative">
      ...
      <div className="relative z-10">
        ...
        {!ready ? (
          ...
          <>
            {/* First row: Tasks (left) + Live Tokens (right) on desktop */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6 lg:max-h-[520px]">
              <div className="animate-arena-reveal min-h-0 flex flex-col" style={{ animationDelay: '0ms' }}>
                <TasksPanel />
              </div>
            ...
            {/* Main layout: leaderboard left, separator, epoch/graduation right */}
            <div className="grid grid-cols-1 lg:grid-cols-[350px_auto_1fr] gap-6">
              ...
              {/* Epoch Rewards + Graduation + Token Marquee + Featured Detail */}
              <div className="min-w-0 space-y-6">
